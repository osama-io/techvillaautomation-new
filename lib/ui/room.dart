...
class RoomScreen extends StatefulWidget {
  int index;
  String name, roomId;
  RoomScreen({required this.name, required this.roomId, required this.index});
            ...
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<Event> snapshot) {
                if (!snapshot.hasData) {
                  ...
                  return Center(child: Text('No data found, please Scan'));
                } else {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return Column(
                          children: [
                            ListTile(
                              ...
                              title: Text(
                                  //  index.toString()
                                  list[index]['deviceName'].toString()),
                              trailing: Row(
                        ...
                        return InkWell(
                          ...
                          child: ListTile(
                            title:
                                Text(list[widget.index][index]['deviceName']),
